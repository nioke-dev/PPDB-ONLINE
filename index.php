...
<body>
    ...
    <header>
        <!-- navbar -->
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent shadow pb-4 pt-4">
            <div class="container">
                <a class="navbar-brand font-weight-bold ppdb-online-header" href="#">PPDB ONLINE</a>
    ...
    <section id="tentang" class="tentang">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="Assets/img/ilustration/undraw_all_the_data_re_hh4w.svg" alt="tentang sekolah" class="img-fluid mx-auto d-block">
                </div>
                <div class="col-md-6">
