                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="input-nama-calon-siswa">Upload Surat Keterangan Lulus</label>
                                                    <input type="file" id="input-nama-calon-siswa" class="form-control" placeholder="Type Here" value="" name="surat-keterangan-lulus">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                    ...
                                    <div class="pl-lg-4">
                                        ...
                                        <div class="row">
                                            <div class="col-4 text-left">
                                                ...
                                                <button type="reset" name="edit" class="btn btn-sm btn-danger">Reset</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
